...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lastfmauth_lastfmuser', (
            ...
            ('playcount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('lastfmauth', ['LastFMUser'])


    def backwards(self, orm):
        
        # Deleting model 'LastFMUser'
        db.delete_table('lastfmauth_lastfmuser')
